...
public class EquipmentService {
    ...
    public Equipment addEquipment(Long hospitalId, Equipment equipment) {
        ...
        // check if hospital exists if yes then assigns equipment to that hospital else
        // throws excption
        Hospital hospital = hospitalRepository.findById(hospitalId)
                .orElseThrow(() -> new EntityNotFoundException("Hospital with " + hospitalId + " does not exists."));
    ...
    public List<Equipment> getAllEquipmentOfHospital(Long hospitalId) throws SQLException {
        ...
        return equipmentRepository.findHospitalById(hospitalId);
